...
// TODO use
const int number_prep_iterations = 40000000;
...
void make_mask(chao_t* chao) {
    ...
    for (int run = 0; run < number_prep_iterations; run++) {
...
int main(int argc, char** argv) {
    ...
    chao_t* chaos[2];
    chaos[0] = make_chao_bin(pent, 5, 30, 0.5, c_teal, width*0.3, height/2, width*0.6);
    chaos[1] = make_chao_bin(pent, 5, 31, 0.5, c_yellow2, width*0.6, height/2, width*0.6);
